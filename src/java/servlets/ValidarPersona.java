...
public class ValidarPersona extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombreAgenda = request.getParameter("nombreAgenda");
        System.out.println("------"+nombreAgenda);
        ImportarExportar ie = new ImportarExportar(nombreAgenda);
        Persona p = ie.importarPersona(new File(nombreAgenda));
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(respuesta.equals("true")){
                out.println("-----------------------");
                out.println("Esta persona es válida");
                out.println("-----------------------");
            }else{
                out.println("-----------------------");
                out.println("La persona no es válida");
                out.println("-----------------------");
            }}else{
